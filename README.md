...
They are built from first principles from training data that has been annotated using the conllu format.
...
All word and character embeddings are built from scratch from conllu annotated corpus. This ensures:
...
- No tokenization conflict between the conllu standard and external tooling
...
- No cross-lingual transfer from high-resource languages
